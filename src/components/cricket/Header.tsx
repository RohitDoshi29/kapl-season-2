...
export function Header({
  ...
  return <header className={cn('relative overflow-hidden py-6 md:py-8', className)}>
      ...
      <div className="relative container mx-auto px-4 text-center">
        <h1 className="text-3xl font-extrabold text-white tracking-tight drop-shadow-lg md:text-8xl">
          KAPL
